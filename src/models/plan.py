...
class Plan(Base, TimestampMixin):
    ...
    storage_limit_bytes = Column(Float, nullable=False, default=5.0,index=True)  # Storage limit in GB
    price_cents= Column(Float, nullable=False, default=0, index=True)  # Price in cents
